...
static inline void tea2_shift_keyreg(uint8_t r[10], uint8_t in)
{
    r[0] = r[1];
    r[1] = r[2];
    r[2] = r[3];
...
static uint8_t tea2_reorder_state_byte(uint8_t bStByte)
{
    ...
    bOut |= (uint8_t)((bStByte << 3) & 0x10);
    bOut |= (uint8_t)((bStByte >> 2) & 0x01);
    bOut |= (uint8_t)((bStByte << 2) & 0x20);
    bOut |= (uint8_t)((bStByte << 3) & 0x80);
    bOut |= (uint8_t)((bStByte >> 4) & 0x02);
    bOut |= (uint8_t)((bStByte >> 3) & 0x08);
    bOut |= (uint8_t)((bStByte >> 5) & 0x04);
    return bOut;
}
